 ...
 *   get:
 *     summary: Obter a lista de favoritos de um usuário específico.
 *     description: Obtém a lista de filmes de um usuário específico.
 *     tags:
 *       - Lista
 *     security:
 *       - bearerAuth: []
 ...
 * /api/list/favoriteMovies:
 *   patch:
 *     summary: Atualizar a lista de favoritos.
 *     description: Atualiza parcialmente uma lista de filmes.
 *     tags:
 *       - Lista
 *     security:
 *       - bearerAuth: []
...
/**
 * @swagger
 * /api/favoriteMovies/remove:
 *   delete:
 *     summary: Remover um filme da lista de favoritos.
 *     description: Remove um filme da lista de filmes do usuário.
 *     tags:
 *       - Lista
 *     security:
 *       - bearerAuth: []
