...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        ...
        <a class="btn btn-warning text-dark btn-link mt-3" href="/getAllLists">Lists: ${profileData.body.profile.contadorlists !== null ? profileData.body.profile.contadorlists : 0}</a>
        <a class="btn btn-warning text-dark btn-link mt-3" href="/getAllReviews">Reviews: 
